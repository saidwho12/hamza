#ifndef HZ_UCD_5_1_0_H
#define HZ_UCD_5_1_0_H

#include <stdint.h>

#define HZ_UCD_VERSION HZ_MAKE_VERSION(5,1,0)
...
uint32_t hz_ucd_arabic_joining_data[274] = {
    ...
    HZ_JOINING_TYPE_D | (HZ_JOINING_GROUP_YEH << 6), /* FARSI YEH WITH INVERTED V */
    ...
    HZ_JOINING_TYPE_D | (HZ_JOINING_GROUP_YEH << 6), /* FARSI YEH WITH 2 DOTS ABOVE */
    ...
    HZ_JOINING_TYPE_D | (HZ_JOINING_GROUP_YEH << 6), /* FARSI YEH WITH 3 DOTS ABOVE */
    ...
    HZ_JOINING_TYPE_D | (HZ_JOINING_GROUP_YEH << 6), /* DOTLESS YEH WITH DIGIT TWO ABOVE */
    ...
    HZ_JOINING_TYPE_D | (HZ_JOINING_GROUP_YEH << 6), /* DOTLESS YEH WITH DIGIT THREE ABOVE */
